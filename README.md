...
The model requires at least python version 3.6.7. In the following, we show the steps to install python 3.12.2 - the procedure is the same for python 3.13 (the latest version, as of October 2024).
